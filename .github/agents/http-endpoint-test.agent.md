...
description: Syncs .http test files in tests/API/ after API endpoint changes.
tools:
  - read
  - edit
  - search
...
1. Read the skill runbook at `.github/skills/autoservice-http-endpoint-test/SKILL.md` for the full sync workflow.
