...
- **`src/pages/Admin/RegisterMechanic/sections/SecuritySection.tsx`**: Password input with show/hide toggle, inline validation messaging, and accessibility metadata (`autoComplete="new-password"`, `aria-invalid`, `aria-describedby`).
