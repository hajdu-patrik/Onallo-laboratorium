...
- `src/pages/Admin/RegisterMechanic/sections/SecuritySection.tsx` — password input with show/hide toggle, inline validation state, and accessibility attributes (`autoComplete="new-password"`, `aria-invalid`, `aria-describedby`)
