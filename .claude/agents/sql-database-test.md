...
description: "SQL database test agent. Syncs .sql validation files in tests/Database/ after schema or persistence changes."
model: sonnet
---
...
1. Read the skill runbook at `.claude/skills/autoservice-sql-database-test/SKILL.md` for the full sync workflow.
