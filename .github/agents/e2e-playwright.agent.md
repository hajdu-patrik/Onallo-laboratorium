...
- The **Frontend Specialist** modified UI components (changed `data-testid`, restructured DOM, renamed roles/labels, added/removed interactive elements).
- The **Backend Specialist** changed DTOs or API contracts that affect UI rendering or test assertions.
